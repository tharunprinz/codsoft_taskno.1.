'''
Hello again everyone! This is Tharun R
Intern at CODSOFT, India.

I'm very thrilled to share my Third Task at CodSoft Internship March 2024 viz. MovieGenre DETECTION MODEL.
...
# AUTHOR: THARUN R
# TASK NAME: MovieGenre Detection
# 4th Task in the List of Tasks
# TASK CATEGORY: Machine Learning
# DATE OF SUBMISSION: 12 March 2024
# LinkedIn Profile: https://www.linkedin.com/in/tharun021/
# GitHub Repository: https://github.com/tharunprinz/CodeSoft-InternShip-Tasks.git
...
try:
    with tqdm(total=50, desc="Loading Train Data") as pbar:
        train_data = pd.read_csv('/Users/tharunr/Downloads/CodSoft-InternshipTasks-main/Task1_MovieGenre/test_data.txt', sep=':::', header=None, names=['SerialNumber', 'MOVIE_NAME', 'GENRE', 'MOVIE_PLOT'], engine='python')
        pbar.update(50)
...
try:
    with tqdm(total=50, desc="Loading Test Data") as pbar:
        test_data = pd.read_csv('/Users/tharunr/Downloads/CodSoft-InternshipTasks-main/Task1_MovieGenre/test_data.txt', sep=':::', header=None, names=['SerialNumber', 'MOVIE_NAME', 'MOVIE_PLOT'], engine='python')
        pbar.update(50)
except Exception as e:
